...
class DBProvider {
  static Database? _database; // _database guarda la instancia de nuestra base de datos
  static final DBProvider db = DBProvider._(); // Contructor privado que crea instancia de la clase
  DBProvider._();
  // Esto es un singleton, un patrón de diseño que permite restringir la creación de objetos
